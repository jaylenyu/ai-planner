...
export function PrivacyContent({ embedded = false }: PrivacyContentProps) {
  return (
    <div
      className={
        embedded
          ? 'space-y-8 text-sm leading-relaxed text-stone-700'
          : 'rounded-3xl bg-white p-10 shadow-xl shadow-stone-200/60'
      }
    >
      <header className="mb-10 border-b border-stone-200 pb-6">
        ...
        <p className="mt-3 text-sm leading-relaxed text-stone-500">
          DatePlanner(이하 &quot;회사&quot;)는 이용자의 개인정보를 중요하게
          생각하며, 개인정보 보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률
          등 관련 법령을 준수합니다. 회사는 개인정보 처리방침을 통하여 이용자에게
          개인정보가 어떠한 목적과 방식으로 수집, 이용, 보관, 파기되는지를 명확히
          안내합니다.
        </p>
      ...
      <section className="space-y-8 text-sm leading-relaxed text-stone-700">
        ...
        <article>
          ...
          <ul className="ml-6 list-disc space-y-1 text-stone-600">
            <li>회원 식별, 가입 의사 확인, 중복 가입 방지 등 계정 관리</li>
            <li>AI 추천, 일정 저장, 알림 등 핵심 서비스 기능 제공</li>
            <li>불법 이용 방지, 보안 위협 탐지, 로그인 시도 제한 등 서비스 안전성 확보</li>
            <li>고객 문의 응대, 공지사항 전달, 서비스 정책 변경 안내</li>
            <li>사용 통계 분석, 서비스 품질 개선, 신규 기능 개발</li>
          </ul>
        </article>
        ...
        <article>
          ...
          <p>
            회사는 개인정보 수집 및 이용 목적이 달성되면 지체 없이 파기합니다. 다만
            관련 법령에 따라 일정 기간 보관이 필요한 경우에는 해당 법령에서 정한 기간
            동안 보관합니다.
          </p>
          <ul className="ml-6 list-disc space-y-1 text-stone-600">
          ...
          <p>
            회원 탈퇴 시에는 지체 없이 개인정보를 파기하며, 법령상 의무 보관이 필요한
            정보는 별도 저장소에서 분리 보관합니다.
          </p>
        </article>
        ...
        <article>
          ...
          <p>회사는 원활한 서비스 제공을 위하여 다음과 같이 개인정보 처리를 위탁할 수 있습니다.</p>
          <ul className="ml-6 list-disc space-y-1 text-stone-600">
          ...
          <p>
            ...
            조치를 명확히 규정하며, 수탁자가 개인정보를 안전하게 처리하도록 관리
            감독합니다.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            회사는 개인 맞춤 서비스를 제공하기 위해 쿠키를 사용합니다. 쿠키는
            서비스를 운영하는 데 사용되는 서버가 이용자의 브라우저에 보내는 소량의
            정보이며, 이용자의 디바이스에 저장될 수 있습니다.
          </p>
        ...
        <article>
          ...
          <p>
            이용자는 언제든지 자신의 개인정보를 열람하거나 정정, 삭제, 처리 정지를
            요구할 수 있습니다.
          </p>
          <p>
            개인정보 열람 또는 처리 정지 요청은 법령에 따라 제한될 수 있으며, 회사는
            지체 없이 필요한 조치를 취하고 결과를 안내합니다.
          </p>
          <p>이용자는 서비스 내 설정 페이지, 고객센터 이메일을 통해 권리를 행사할 수 있습니다.</p>
          <p>
            만 14세 미만 아동의 경우 개인정보 제공과 권리 행사는 법정대리인을 통해
            이루어져야 합니다.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            법령에 따라 일정 기간 저장해야 하는 경우에는 별도의 DB로 옮겨 비공개
            상태로 보관합니다.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            회사는 글로벌 클라우드 인프라를 활용하여 서비스를 운영할 수 있으며, 이
            과정에서 개인정보가 국외로 이전될 수 있습니다.
          </p>
          <p>
            국외 이전이 발생하는 경우 관련 법령에서 요구하는 절차와 안전성 확보
            조치를 준수하고, 이전 대상, 국가, 이전 일시, 보유 기간 등을 이용자에게
            사전 고지합니다.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            이용자와 법정대리인은 언제든지 개인정보 열람, 정정, 삭제, 처리 정지
            요구를 할 수 있으며, 회사는 지체 없이 이에 응합니다.
          </p>
          <p>권리 행사는 서면, 이메일, 고객센터 등으로 요청할 수 있으며, 대리인을 통해서도 가능합니다.</p>
          <p>
            회사는 정당한 권리 행사를 거부하지 않으며, 열람 또는 처리 정지 요청이
            법령에 위반되는 경우에는 그 사유를 명확히 안내합니다.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            회사는 개인정보 보호와 관련한 업무를 총괄하는 개인정보 보호책임자를
            지정하고 있습니다.
          </p>
          <div className="mt-3 rounded-2xl border border-stone-200 bg-stone-50 p-4 text-sm text-stone-700">
            ...
            <p>이름: 유정인</p>
            <p>직책: CTO / 기술 총괄</p>
            <p>이메일: jaylenyu96@gmail.com</p>
          </div>
          <p className="mt-3">
            이용자는 서비스를 이용하며 발생하는 모든 개인정보 보호 관련 문의, 불만
            처리, 피해 구제 등을 개인정보 보호책임자에게 요청할 수 있습니다.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            이용자는 개인정보 침해에 대한 피해를 구제받기 위하여 개인정보
            분쟁조정위원회, 개인정보 침해신고센터 등에 분쟁 해결이나 상담을 신청할 수
            있습니다.
          </p>
          <ul className="ml-6 list-disc space-y-1 text-stone-600">
        ...
        <article>
          ...
          <p>
            회사는 법령 또는 서비스 정책 변경에 따라 개인정보 처리방침을 개정할 수
            있으며, 개정 내용과 시행일을 최소 7일 전에 공지합니다.
          </p>
          <p>
            이용자가 개정된 처리방침에 동의하지 않을 경우 서비스 이용을 중단하고
            탈퇴할 수 있습니다. 별도의 의사 표시가 없으면 변경된 내용에 동의한 것으로
            간주합니다.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            본 개인정보 처리방침은 2026년 4월 14일부터 적용되며, 이전에 시행되던
            처리방침은 본 방침으로 대체됩니다.
          </p>
          <p>
            회사는 개인정보 보호를 위해 필요한 경우 별도의 추가 정책을 수립할 수
            있으며, 추가 정책은 본 방침과 동일한 효력을 갖습니다.
          </p>
        </article>
      </section>
    </div>
