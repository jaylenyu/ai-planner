  ...
  const workspaceCard = useMemo(() => {
    if (!workspace) {
      return {
        ...
        ctaLabel: status?.hasAccess ? '워크스페이스 만들기' : '구독하고 시작하기',
      };
    }
            ...
            <div className="space-y-6">
              ...
              <AppCard padding="lg" className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-lg font-bold text-stone-900">보관함 요약</h2>
                </div>
                {plansLoading ? (
                  <p className="text-sm text-stone-500">일정을 불러오는 중...</p>
                ) : (
                  <>
                    <div className="grid grid-cols-3 gap-3">
                      <div className="rounded-2xl bg-stone-50 px-4 py-4 text-center">
                        <p className="text-xs font-semibold text-stone-500">전체</p>
                        <p className="mt-1 text-2xl font-bold text-stone-900">{plans.length}</p>
                      </div>
                      <div className="rounded-2xl bg-stone-50 px-4 py-4 text-center">
                        <p className="text-xs font-semibold text-stone-500">공유</p>
                        <p className="mt-1 text-2xl font-bold text-stone-900">
                          {sharedPlans.length}
                        </p>
                      </div>
                      <div className="rounded-2xl bg-stone-50 px-4 py-4 text-center">
                        <p className="text-xs font-semibold text-stone-500">최근</p>
                        <p className="mt-1 text-2xl font-bold text-stone-900">
                          {recentPlans.length}
                        </p>
                      </div>
              ...
              <AppCard padding="lg" className="space-y-4">
                ...
                {notificationsLoading ? (
                  <p className="text-sm text-stone-500">알림을 확인하는 중...</p>
                ) : (
                  <>
                    <div className="rounded-2xl border border-stone-200 bg-stone-50 px-4 py-4 text-sm text-stone-700">
                      <p className="font-semibold text-stone-900">
