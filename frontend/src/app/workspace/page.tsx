          ...
          <AppCard padding="lg" className="space-y-6 overflow-hidden">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
              <div className="max-w-2xl space-y-3">
                <p className="text-sm font-semibold text-orange-600">커플 플랜</p>
                <h1 className="text-3xl font-bold text-stone-900 sm:text-4xl">
                  플랜 오너와 파트너가 함께 쓰는 공유 공간
                </h1>
                <p className="break-keep text-sm leading-6 text-stone-600">
                  플랜 오너는 생성, 초대, 초대 링크 관리, 해체를 맡고 파트너는
                  초대 수락, 공유 일정 열람·수정, 메모 작성, 공유 플랜 활용을
                  맡습니다.
                </p>
              </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            >
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                ...
                <li>보관함의 공유 플랜을 열어 수정과 메모를 이어갑니다.</li>
              </ul>
            </AppCard>
          </div>
